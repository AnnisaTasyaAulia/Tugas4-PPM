...
const Order = () => {
    ...
    const { name = 'Wet Food', image = require('../../assets/wet_food.jpeg'), price = '3.80' } = route.params || {};
        ...
        <View style={styles.container}>
            ...
            <View style={styles.addressContainer}>
                ...
                <View style={styles.addressButtonsContainer}>
                    ...
                    <TouchableOpacity style={styles.addressButton}>
                        <Image source={require('../../assets/dokumen.png')} style={styles.smallIcon} />
            ...
            <View style={styles.discountContainer}>
                <Image source={require('../../assets/diskon.png')} style={styles.discountIcon} />
            ...
            <View style={styles.paymentSummary}>
                ...
                <View style={styles.paymentRow}>
                    ...
                    <Text style={styles.paymentTotal}>$ 8.00</Text>
                </View>
            </View>

            <View style={styles.paymentMethodContainer}>
                <Image source={require('../../assets/money.png')} style={styles.paymentIcon} />
                <Text style={styles.paymentMethodText}>Cash</Text>
                <Text style={styles.paymentMethodAmount}>$ 8.00</Text>
                <Image source={require('../../assets/dot.png')} style={styles.dotsIcon} />
            </View>
