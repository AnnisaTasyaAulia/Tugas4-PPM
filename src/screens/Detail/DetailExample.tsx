      ...
      <View style={styles.container}>
          <View style={styles.header}>
              ...
              <TouchableOpacity onPress={toggleLike}>
                  <Image
                      source={liked ? require('../../assets/favorite.jpeg') : require('../../assets/favorite.jpeg')}
          ...
          <Text style={styles.coba}>{description}</Text>
          ...
          Royal Canin adalah jenis wet food terbaik dengan berbagai macam varian yang dapat...
              <Text style={styles.readMore}>Read More</Text>
          </Text>


          <Text style={styles.sectionTitle}>Buy For</Text>
          <View style={styles.sizeContainer}>
              {['Adult', 'Kitten', 'Kombo'].map((size, index) => (
          ...
          <View style={styles.footer}>
              ...
              onPress={() => navigation.navigate('Order', { name, image, price })}>
